...
export function initRooms() {
  ...
  (function buildBakery() {
    ...
    setupRoomMetadata(g, 'S07', [26, 10, 26], [
      { id: 'royal_oven', name: 'Royal Confectionery Oven', position: [0, 1.5, -8], type: 'bake' }
    ]);
  })();
...
with open('/data/data/com.termux/files/home/projects/resident-lovely-game/src/world/rooms.js', 'w') as f:
    f.write(content)

print("SUCCESS: rooms.js updated.")
