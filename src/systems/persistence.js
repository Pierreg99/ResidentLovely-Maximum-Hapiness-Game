...
export function saveGame(gameState, lanternMeshes, QUESTS) {
  const savePayload = {
    ...
    astrolabeSolved: gameState.astrolabeSolved,
    clockSolved: gameState.clockSolved,
    dynamoActive: gameState.dynamoActive,
...
export function loadGame(gameState, lanternMeshes, QUESTS, inventorySystem, questSystem) {
  ...
  if (data) {
    try {
      ...
      gameState.astrolabeSolved = p.astrolabeSolved || false;
      gameState.clockSolved = p.clockSolved || false;
      gameState.dynamoActive = p.dynamoActive || false;
